...
const TIPS = [
  {
    ...
    message:
      "We're preparing your project environment and analyzing your requirements using AI.",
  },
  {
    title: "Did you know?",
    message:
      "We're using AI to analyze your requirements and generate custom code tailored specifically to your needs.",
  },
  {
    title: "Pro tip",
    message:
      "You can make changes to your miniapp after it's generated! Just chat with the AI to refine your project.",
  },
  {
    title: "Behind the scenes",
    message:
      "We're setting up your entire tech stack including Next.js, TypeScript, and blockchain integrations automatically.",
  },
];
...
export function DevelopmentLogs({
  ...
  const [currentStage, setCurrentStage] = useState(() => {
    ...
    if (stored && generationId && stored.generationId === generationId) {
      ...
      const quickStageDurations = [
        60000, 70000, 80000, 90000, 70000, 60000, 50000, 40000, 80000,
      ];
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white">
      <div className="text-center max-w-lg w-full">
        ...
        {/* Current Stage */}
        <div className="mb-8">
          <p className="text-2xl font-bold text-gray-900 mb-2 flex items-center justify-center gap-1.5">
            <span>
              {BUILDING_STAGES[currentStage]?.icon || "🚀"}{" "}
              {BUILDING_STAGES[currentStage]?.text ||
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-5 mb-6 shadow-md min-h-[120px] relative overflow-hidden">
          ...
          <div className="relative">
            <div
              ...
              key={currentTipIndex}
            >
              <div className="text-blue-600 text-2xl flex-shrink-0 mt-0.5">
                💡
              </div>
