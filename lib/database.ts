...
export async function createUser(farcasterFid: string, username?: string, displayName?: string, pfpUrl?: string) {
...
export async function getUserByFarcasterFid(farcasterFid: string) {
  try {
